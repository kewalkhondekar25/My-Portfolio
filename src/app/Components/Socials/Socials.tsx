...
const Socials = () => {
    ...
    const handleSocials = (platform: number) => {
        if(platform == 1){
            window.open('https://github.com/kewalkhondekar25', '_blank');
        }else if(platform === 2){
            ...
            window.open('https://www.instagram.com/kewal.khondekar25/', '_blank');
        }else if(platform === 5){
    ...
    return (
        <div className='relative'>
            {/* <div className='absolute top-[12vh] uppercase text-gray-500 text-[1.5vh] font-bold'>
                socials
            </div> */}
            <div className='flex h-[20vw] w-[60vw]
            2xl:h-[20vw] 2xl:w-[20vw]
            xl:h-[10vw] xl:w-[20vw]
            lg:h-[10vw] lg:w-[20vw]
            md:h-[10vw] md:w-[30vw]
            sm:h-[10vw] sm:w-[20vw]'>
